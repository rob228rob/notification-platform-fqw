...
echo.
echo Replace c0837ca1-6f89-452b-9dce-14f5521f36a6 and VERSION below with values from CreateTemplate response.

echo === PublishTemplate ===
"%GRPCURL%" -plaintext %IMPORTS% %PROTO% ^
  -d "{\"templateId\":\"c0837ca1-6f89-452b-9dce-14f5521f36a6\",\"version\":1}" ^
  %TARGET% %SERVICE%/PublishTemplate

echo === GetTemplate (active) ===
"%GRPCURL%" -plaintext %IMPORTS% %PROTO% ^
  -d "{\"templateId\":\"c0837ca1-6f89-452b-9dce-14f5521f36a6\"}" ^
...
echo === RenderPreview ===
"%GRPCURL%" -plaintext %IMPORTS% %PROTO% ^
  -d "{\"templateId\":\"c0837ca1-6f89-452b-9dce-14f5521f36a6\",\"version\":1,\"channel\":\"CHANNEL_EMAIL\",\"payload\":{\"name\":\"Alice\"}}" ^
